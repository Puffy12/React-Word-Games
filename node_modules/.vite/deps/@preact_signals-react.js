...
var x;
var k = Symbol.dispose || Symbol.for("Symbol.dispose");
function w2(n2, r2) {
  var t2 = r2.effect.S();
  x = r2;
  return B.bind(r2, n2, t2);
}
function B(n2, r2) {
  r2();
  x = n2;
...
var O;
var P;
var $ = ((O = { u: 0, effect: { s: void 0, c: function() {
}, S: function() {
  return S;
}, d: function() {
} }, subscribe: function() {
...
function M(n2) {
  if (void 0 === n2)
    n2 = 0;
  I();
  var r2 = (0, import_react.useRef)();
  if (null == r2.current)
    r2.current = function(n3) {
      var r3, t3, i3, u3, f3 = 0, o3 = E(function() {
        t3 = this;
      });
      t3.c = function() {
        f3 = f3 + 1 | 0;
      ...
      return (r3 = { u: n3, effect: t3, subscribe: function(n4) {
        u3 = n4;
        return function() {
          f3 = f3 + 1 | 0;
          u3 = void 0;
        ...
        if (null != x) {
          var n4 = x.u, r4 = this.u;
          if (0 == n4 && 0 == r4 || 0 == n4 && 1 == r4) {
            x.f();
            i3 = w2(void 0, this);
          } else if (1 == n4 && 0 == r4 || 2 == n4 && 0 == r4)
            ;
          else
            i3 = w2(x, this);
        } else
  ...
  var t2 = r2.current;
  (0, import_shim.useSyncExternalStore)(t2.subscribe, t2.getSnapshot, t2.getSnapshot);
  t2.S();
  return t2;
}
Object.defineProperties(u.prototype, { $$typeof: { configurable: true, value: _2 }, type: { configurable: true, value: function(n2) {
  var r2 = n2.data, t2 = M(1);
  try {
    return r2.value;
  } finally {
    t2.f();
...
function useComputed(n2) {
  var r2 = (0, import_react.useRef)(n2);
  r2.current = n2;
  return (0, import_react.useMemo)(function() {
    return w(function() {
      return r2.current();
...
use-sync-external-store/cjs/use-sync-external-store-shim.development.js:
   ...
   *)
*/
//# sourceMappingURL=@preact_signals-react.js.map
