...
export const data6 = {
  across: {
    1: { clue: 'It "puts you there where things are hollow," in a David Bowie hit', answer: 'FAME', row: 0, col: 1 },
    5: { clue: 'What QR codes at restaurants lead to', answer: 'MENUS', row: 1, col: 0 },
    6: { clue: 'Top of the top', answer: 'ELITE', row: 2, col: 0 },
    7: { clue: 'Subject of a marathoners P.R.', answer: 'TIME', row: 3, col: 0 },
    8: { clue: 'Log chopper', answer: 'AXE', row: 4, col: 0 },
  },
  down: { 
    1: { clue: '___ Felicis, potion in the Harry Potter books known as "Liquid Luck"', answer: 'FELIX', row: 0, col: 1 },
    2: { clue: 'Japanese cartoon genre', answer: 'ANIME', row: 0, col: 2 },
    3: { clue: 'Zoom call button', answer: 'MUTE', row: 0, col: 3 },
    4: { clue: 'Suffix with Senegal or Sudan', answer: 'ESE', row: 0, col: 4 },
...
export const data8 = {
  across: {
    1: { clue: '"Largemouth" lake animal', answer: 'BASS', row: 0, col: 1 },
    5: { clue: 'Arousing suspicion', answer: 'FISHY', row: 1, col: 0 },
    6: { clue: '"Citizen Kane" director Welles', answer: 'ORSON', row: 2, col: 0 },
    7: { clue: 'Point after deuce, in tennis', answer: 'ADOUT', row: 3, col: 0 },
    8: { clue: 'Joyous laughter', answer: 'MIRTH', row: 4, col: 0 },
    9: { clue: 'Slowly sinks, as the sun', answer: 'SETS', row: 5, col: 0 },
  },
  down: { 
    1: { clue: 'Score of 3 on a par 4, e.g.', answer: 'BIRDIE', row: 0, col: 1 },
    2: { clue: 'Classify into separate groups', answer: 'ASSORT', row: 0, col: 2 },
    3: { clue: 'SPEAKS LIKE THIS', answer: 'SHOUTS', row: 0, col: 3 },
    4: { clue: 'Instrument in electronic dance music, for short', answer: 'SYNTH', row: 0, col: 4 },
    5: { clue: 'Becomes bubbly, as beer', answer: 'FOAMS', row: 1, col: 0 }, 
   },
} as const;

export const data9 = {
  across: {
    1: { clue: 'Thermometer reading, for short', answer: 'TEMP', row: 0, col: 1 },
    5: { clue: 'What the letters of ROY G. BIV stand for', answer: 'COLORS', row: 1, col: 0 },
    7: { clue: 'Totally rad', answer: 'AWESOME', row: 2, col: 0 },
    9: { clue: 'Equivalent of 165 bottles of beer', answer: 'KEG', row: 3, col: 0 },
    10: { clue: 'Spanish for "aunt"', answer: 'TIA', row: 3, col: 4 },
    11: { clue: 'Pink Pearls are classic ones', answer: 'ERASERS', row: 4, col: 0 },
    13: { clue: 'Devious', answer: 'SNEAKY', row: 5, col: 1 },
    14: { clue: 'Male cats or turkeys', answer: 'TOMS', row: 6, col: 2 }
  },
  down: { 
    1: { clue: '"The Two ___," second volume of the "Lord of the Rings" trilogy', answer: 'TOWERS', row: 0, col: 1 },
    2: { clue: 'Gracefully stylish', answer: 'ELEGANT', row: 0, col: 2 },
    3: { clue: 'Jun., Jul., Aug., etc.', answer: 'MOS', row: 0, col: 3 },
    4: { clue: 'The 76ers or the 49ers', answer: 'PROTEAM', row: 0, col: 4 },
    5: { clue: 'Serving at a birthday party', answer: 'CAKE', row: 1, col: 0 },  
    6: { clue: 'Self-satisfied smiles', answer: 'SMIRK', row: 1, col: 5 },
    8: { clue: '"Piece of 5-Down!"', answer: 'EASY', row: 2, col: 6 },
    12: { clue: 'Improvement of a web pages visibility, for short', answer: 'SEO', row: 4, col: 3 },
  },
} as const;
...
export const data19 = {
  across: {
    1: { clue: 'Substance used by violin players', answer: 'ROSIN', row: 0, col: 0 },
    6: { clue: 'One of the worlds largest land animals, familiarly', answer: 'HIPPO', row: 1, col: 0 },
    7: { clue: 'Trojan War epic', answer: 'ILIAD', row: 2, col: 0 },
    8: { clue: 'N.B.A. team that recently agreed to its first trade with the Knicks in over 40 years', answer: 'NETS', row: 3, col: 0 },
    9: { clue: 'Lyric poems', answer: 'ODES', row: 4, col: 0 },
  },
  down: { 
    1: { clue: 'One of the worlds largest land animals, familiarly', answer: 'RHINO', row: 0, col: 0 },
    2: { clue: 'Well-___ machine', answer: 'OILED', row: 0, col: 1 },
    3: { clue: 'Petty ill will', answer: 'SPITE', row: 0, col: 2 },
    4: { clue: '"Skip me," in a game', answer: 'IPASS', row: 0, col: 3 },
    5: { clue: 'Nonverbal agreement', answer: 'NOD', row: 0, col: 4 },  
  },
} as const;

export const data20 = {
  across: {
    1: { clue: 'Website born from its C.E.Os "personal film diary"', answer: 'IMDB', row: 0, col: 1 },
    5: { clue: 'Service symbolized by an evelope', answer: 'EMAIL', row: 1, col: 0 },
    6: { clue: 'Japanese writing system based on Chinese characters', answer: 'KANJI', row: 2, col: 0 },
    7: { clue: 'Some frozen waffles', answer: 'EGGOS', row: 3, col: 0 },
    8: { clue: 'Ages and ages', answer: 'EONS', row: 4, col: 1 },
  },
  down: { 
    1: { clue: 'P.R. concern', answer: 'IMAGE', row: 0, col: 1 },
    2: { clue: 'Fruit that may be served with sticky rice', answer: 'MANGO', row: 0, col: 2 },
    3: { clue: 'Spicy mustard', answer: 'DIJON', row: 0, col: 3 },
    4: { clue: 'Pure joy', answer: 'BLISS', row: 0, col: 4 },
    5: { clue: '__ out a living (barely get by)', answer: 'EKE', row: 1, col: 0 },  
  },
} as const;
